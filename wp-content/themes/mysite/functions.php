...
function mysite_scripts() {
	wp_enqueue_style( 'mysite-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'mysite-style', 'rtl', 'replace' );

	wp_enqueue_script( 'mysite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
